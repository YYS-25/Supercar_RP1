...
<head>
    ...
    <style>
        ...
        .main-title {
          ...
          color: crimson;
          font-weight: bold;
          text-shadow: 2px 2px 4px rgba(133, 3, 3, 0.1);
          margin: 0;
          padding: 10px;
        }
    </style>
    ...
    <script>
        function populateModal(car) {
            const clientSource = "https://site-supercar.alwaysdata.net/";
            ...
            document.getElementById('modal-preview-image').src = clientSource + car.image;
            ...
            document.getElementById('modal-explore_img1').value = clientSource +  car.explore_img1;
            document.getElementById('modal-explore_img2').value = clientSource +  car.explore_img2;
            document.getElementById('modal-explore_img3').value = clientSource +  car.explore_img3;
            ...
            document.getElementById('carouselImage1').src = clientSource + car.explore_img1;
            document.getElementById('carouselImage2').src = clientSource +  car.explore_img2;
            document.getElementById('carouselImage3').src = clientSource +  car.explore_img3;
        }
    </script>
</head>
<body>
<div class="container mt-5">
     <div class="card text-center" style="margin-top: 20px; padding: 24px 0px; background: linear-gradient(135deg, #f97373ff, #fff07fff); border-radius: 15px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.3);">
        <h1 class="main-title">Gestion des Voitures</h1>
        <p class="text-muted" style="color: #333;">Modifier les informations des voitures dans la base de données.</p>
    </div>
            ...
            <tr>
                ...
                <td>
                  <?php if (!empty($car['image'])): ?>
                    <img src="<?= 'https://site-supercar.alwaysdata.net/' .  htmlspecialchars($car['image']) ?>" alt="" style="height:75px;">
                  <?php endif; ?>
                </td>
