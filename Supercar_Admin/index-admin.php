...
$result_test_drives = mysqli_query($conn, $query_test_drives);
...
$result_contacts = mysqli_query($conn, $query_contacts);
if (!$result_contacts) {
    die("Query failed: " . mysqli_error($conn));
}
...
if (isset($_POST['delete_note'])) {
    ...
    $result = mysqli_query($conn, "SELECT id FROM admin_notes ORDER BY created_at ASC");
    $notes = [];
    ...
    if (isset($notes[$lineToDelete - 1])) {
        ...
        mysqli_query($conn, "DELETE FROM admin_notes WHERE id = $noteIdToDelete");
    }
...
<body>
    ...
    <div class="container text-center">
        ...
        <div class="dashboard-cards mt-4">
            <a href="view-logged-accounts.php" class="text-decoration-none">
                <div class="card bg-gold text-white p-3" style="width: 18rem; background-color: #fcbd00ff;">
                    <div class="card-body">
            ...
            <a href="view-trial-requests.php" class="text-decoration-none">
                <div class="card bg-crimson text-white p-3" style="width: 18rem; background-color: crimson;">
                    <div class="card-body">
            ...
            <a href="view-contact-requests.php" class="text-decoration-none">
                <div class="card text-white p-3" style="width: 18rem; background-color: #2F4F4F;">
                    <div class="card-body">
    ...
    <!--stores each note in an array $notes as an associative array with the id and the note-->
     <?php
        $result = mysqli_query($conn, "SELECT * FROM admin_notes ORDER BY created_at ASC");
        $notes = [];
        $count = 1;
        while ($row = mysqli_fetch_assoc($result)) {
        ...
        document.addEventListener("DOMContentLoaded", function() {
            const data = {
                ...
                datasets: [{
                    ...
                    backgroundColor: ['#fcbd00a5', '#d62828a5', '#2F4F4Fa5'],
                    borderColor: ['#fcbd00', '#d62828', '#2F4F4F'],
                    borderWidth: 1
                }]
            };
